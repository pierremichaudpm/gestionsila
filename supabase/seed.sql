...
begin
  insert into auth.users (
    ...
    ('00000000-0000-0000-0000-000000000000', '33333333-0000-0000-0000-000000000002',
     'authenticated', 'authenticated', 'pierre.michaud@jaxa.ca', pw,
     now(), '{"provider":"email","providers":["email"]}'::jsonb, '{}'::jsonb,
     now(), now(), '', '', '', ''),
...
-- ----------------------------------------------------------------------------
-- has_producer_access : true pour les 5 personnes nommées par Virginie
-- (Espace Producteurs / migration 009). Tous les autres restent à false par défaut.
insert into public.project_members (project_id, org_id, user_id, access_level, has_producer_access) values
  ('11111111-1111-1111-1111-111111111111', '22222222-0000-0000-0000-000000000001', '33333333-0000-0000-0000-000000000001', 'admin',              true),  -- Virginie
  ('11111111-1111-1111-1111-111111111111', '22222222-0000-0000-0000-000000000001', '33333333-0000-0000-0000-000000000002', 'production_manager', false), -- Pierre Michaud
  ('11111111-1111-1111-1111-111111111111', '22222222-0000-0000-0000-000000000002', '33333333-0000-0000-0000-000000000003', 'coproducer',         false), -- Mathieu
  ('11111111-1111-1111-1111-111111111111', '22222222-0000-0000-0000-000000000002', '33333333-0000-0000-0000-000000000004', 'coproducer',         true),  -- Marie
  ('11111111-1111-1111-1111-111111111111', '22222222-0000-0000-0000-000000000002', '33333333-0000-0000-0000-000000000005', 'production_manager', true),  -- William
...
-- ----------------------------------------------------------------------------
-- Project settings (Phase 2 — taux de change EUR→CAD fixe pour SILA)
-- ----------------------------------------------------------------------------
insert into public.project_settings (project_id, exchange_rate_eur_to_cad) values
  ('11111111-1111-1111-1111-111111111111', 1.50);

-- ----------------------------------------------------------------------------
-- Budget lines (Phase 2 — exemples par coproducteur)
-- IDs convention : 66...
-- ----------------------------------------------------------------------------
insert into public.budget_lines (id, project_id, lot_id, org_id, category, planned, actual, currency) values
  -- JAXA Production (CAD)
  ('66666666-0000-0000-0000-000000000001', '11111111-1111-1111-1111-111111111111',
   null, '22222222-0000-0000-0000-000000000001', 'Développement',     30000.00,  5500.00, 'CAD'),
  ('66666666-0000-0000-0000-000000000002', '11111111-1111-1111-1111-111111111111',
   ...
   'Tournage',           45000.00, 12000.00, 'CAD'),
  ('66666666-0000-0000-0000-000000000003', '11111111-1111-1111-1111-111111111111',
   null, '22222222-0000-0000-0000-000000000001', 'Post-production',   55000.00,     0.00, 'CAD'),
  ('66666666-0000-0000-0000-000000000004', '11111111-1111-1111-1111-111111111111',
   null, '22222222-0000-0000-0000-000000000001', 'Frais généraux',     8000.00,  2100.00, 'CAD'),
  ...
  ('66666666-0000-0000-0000-000000000007', '11111111-1111-1111-1111-111111111111',
   ...
   'Intégration VR',     38000.00,  4500.00, 'EUR'),
  ('66666666-0000-0000-0000-000000000008', '11111111-1111-1111-1111-111111111111',
   null, '22222222-0000-0000-0000-000000000002', 'Régie',              7500.00,  1200.00, 'EUR'),
  ...
  ('66666666-0000-0000-0000-000000000009', '11111111-1111-1111-1111-111111111111',
   ...
   'Développement',      20000.00,  6000.00, 'EUR'),
  ('66666666-0000-0000-0000-000000000010', '11111111-1111-1111-1111-111111111111',
   '44444444-0000-0000-0000-000000000003', '22222222-0000-0000-0000-000000000003',
   'Production',         85000.00,     0.00, 'EUR'),
...
-- IDs convention 88...
-- ----------------------------------------------------------------------------
insert into public.deliverables (id, funder_id, title, due_date, status) values
  ('88888888-0000-0000-0000-000000000001', '55555555-0000-0000-0000-000000000001',
   'Rapport SODEC Q2',                   '2026-06-30', 'in_progress'),
  ('88888888-0000-0000-0000-000000000002', '55555555-0000-0000-0000-000000000002',
   'CNC — bilan création immersive',     '2026-08-15', 'to_produce'),
  ('88888888-0000-0000-0000-000000000003', '55555555-0000-0000-0000-000000000003',
   'FilmFund Dév. — note d''intention',  '2026-05-30', 'submitted'),
  ('88888888-0000-0000-0000-000000000004', '55555555-0000-0000-0000-000000000004',
   'FilmFund Prod. — convention signée', '2026-09-30', 'to_produce'),
  ('88888888-0000-0000-0000-000000000005', '55555555-0000-0000-0000-000000000006',
   'Région SUD PACA — bilan 2026',       '2027-01-15', 'to_produce');
